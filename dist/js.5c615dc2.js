...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"assets/js/fetchApis.js":[function(require,module,exports) {
var define;
"use strict";
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          _context2.prev = 0;
          _context2.next = 3;
          return fetch('http://localhost:8003/api/endpoint');
        case 3:
        ...
        case 12:
          ...
          console.error('Erro ao buscar dados:', _context2.t0);
        case 15:
        case "end":
...
var _fetchApis = _interopRequireDefault(require("./fetchApis"));
...
function displayImages() {
  return _displayImages.apply(this, arguments);
} // Função para adicionar os eventos de clique às imagens
function _displayImages() {
  _displayImages = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    var data, postsList;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.next = 2;
          return (0, _fetchApis.default)();
        case 2:
          data = _context.sent;
          try {
            postsList = data.map(function (item) {
              return "\n            <article data-description=\"".concat(item.descricao, "\">\n              <figure>\n                <img src=\"").concat(item.imgUrl, "\" alt=\"").concat(item.alt, "\" />\n              </figure>\n            </article>\n          ");
            }).join('');
...
function addImageClickEvents() {
  ...
  images.forEach(function (img) {
    img.addEventListener("click", function () {
      ...
      var description = article ? article.dataset.description : '';
      var caption = description || this.alt;
      captionText.innerHTML = "<p>".concat(caption, "</p>");
    });
  });
}
...
},{"./fetchApis":"assets/js/fetchApis.js"}],"../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
